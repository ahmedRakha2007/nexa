 ...
 */
friendShipRouter.patch("/:id/accept", authMiddleware, friendShipIdValidation, validateRequest, acceptFriendRequest);
/**
 * @swagger
 ...
 *         description: Friend request not found
 */
friendShipRouter.patch("/:id/reject", authMiddleware, friendShipIdValidation, validateRequest, rejectFriendRequest);
/**
 * @swagger
 ...
 *         description: Friend request not found
 */
friendShipRouter.patch("/:id/cancel", authMiddleware, friendShipIdValidation, validateRequest, cancelFriendRequest);
/**
 * @swagger
 * /friendships/friends:
 *   get:
 ...
 */
friendShipRouter.delete("/:id", authMiddleware, friendShipIdValidation, validateRequest, removeFriend);
export default friendShipRouter;
//# sourceMappingURL=friendship.routes.js.map